"""
Django settings for ShakeHands project.
...
SECRET_KEY = 'qiak(2l%2=nf+ijex!p-1x)qh%)+b1$20_5%0d#vf2k56ks9ko'
...
WSGI_APPLICATION = 'ShakeHands.wsgi.application'
