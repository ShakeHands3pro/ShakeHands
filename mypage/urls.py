...
urlpatterns = [
    ...
    path('setting/jobhunting/internship/update',views.internshipRec_update.as_view(), name='jobhunting_internRec_update'),
    path('setting/jobhunting/internship/delete',views.internshipRec_delete.as_view(), name='jobhunting_internRec_delete'),
    ...
    path('setting/jobhunting/prospectiveEmployer/update',views.prospectiveEmployer_update.as_view(), name='jobhunting_prospectiveEmployer_update'),
    path('setting/jobhunting/prospectiveEmployer/delete',views.prospectiveEmployer_delete.as_view(), name='jobhunting_prospectiveEmployer_delete'),
]